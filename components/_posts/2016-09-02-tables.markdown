        ...
        <table class="tables-v2">
          <thead>
            <tr>
              ...
              <th scope="col"><button class="header">Revenue  <i class="iv2-arrow-down2"></i></button></th>
              <th scope="col"><button class="header">Unsubscribe %  <i class="iv2-arrow-down2"></i></button></th>
            </tr>
          </thead>
          <tbody>
            <tr class="avg">
              <td data-label="Property"><i class="iv2-smile"></i><i class="iv2-sad2"></i>BRAND AVERAGE</td>
