...
<div class="unified-gfs">
       ...
       <div class="col-xs-12">
            ...
            <div class="col-xs-12">
                <div class="form-group">
                    <label>10-point range example</label>
                    <div class="range-buttons r_range_buttons question mobile-hide">
                        <ul>
                            <li>
                                <i class="fa fa-frown-o"></i>
                            ...
                            <li>
                                <div class="range-10-point value-0">1</div>
                                <input class="r_nps_1" type="radio" value="1" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-1">2</div>
                                <input class="r_nps_2" type="radio" value="2" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-2">3</div>
                                <input class="r_nps_3" type="radio" value="3" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-3">4</div>
                                <input class="r_nps_4" type="radio" value="4" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-4">5</div>
                                <input class="r_nps_5" type="radio" value="5" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-5">6</div>
                                <input class="r_nps_6" type="radio" value="6" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-6">7</div>
                                <input class="r_nps_7" type="radio" value="7" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-7">8</div>
                                <input class="r_nps_8" type="radio" value="8" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-8">9</div>
                                <input class="r_nps_9" type="radio" value="9" name="question_range_10005">
                            </li>
                            <li>
                                <div class="range-10-point value-9">10</div>
                                <input class="r_nps_10" type="radio" value="10" name="question_range_10005">
                            </li>
                            <li>
                                <i class="fa fa-smile-o"></i>
                    ...
                    <div class="row mobile-show">
                        <div class="col-xs-12">
                            <div class="nps-slider range-slider">
                                <ul><li>Select a score</li></ul>
                                <input class="r_range_slider" type="range" name="range_slider_ignore" min="1" max="10" value="" onclick="">
                                <div class="slider-values">
        ...
        <div class="col-xs-12">
         ...
         <div class="col-xs-12">
             <div class="form-group">
                 <label>4-point range example</label>
                 <div class="range-buttons r_range_buttons question mobile-hide">
                     <ul>
                         <li>
                             <i class="fa fa-frown-o"></i>
                         ...
                         <li>
                             <div class="range-4-point value-0">1</div>
                             <input class="r_nps_1" type="radio" value="1" name="question_range_10005">
                         </li>
                         <li>
                             <div class="range-4-point value-1">2</div>
                             <input class="r_nps_2" type="radio" value="2" name="question_range_10005">
                         </li>
                         <li>
                             <div class="range-4-point value-2">3</div>
                             <input class="r_nps_3" type="radio" value="3" name="question_range_10005">
                         </li>
                         <li>
                             <div class="range-4-point value-3">4</div>
                             <input class="r_nps_4" type="radio" value="4" name="question_range_10005">
                         </li>
                         <li>
                             <i class="fa fa-smile-o"></i>
                 ...
                 <div class="row mobile-show">
                     <div class="col-xs-12">
                         <div class="nps-slider range-slider">
                             <ul><li>Select a score</li></ul>
                             <input class="r_range_slider" type="range" name="range_slider_ignore" min="1" max="4" value="" onclick="">
                             <div class="slider-values">
                                 <span class="min-val pull-left">1</span>
                                 <span class="max-val pull-right">4</span>
                             </div>
                             <div class="slider-values">
                                 <i class="fa fa-frown-o pull-left"></i>
                                 <i class="fa fa-smile-o pull-right"></i>
    ...
    <div class="row">
        <div class="col-sm-12 text-center">
            <address>
                <strong>Avertine International Las Vegas</strong><br>
                Fashion Show Drive<br>Las Vegas, NV 89109
            </address>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <p class="copyright text-center">&copy; 2017 Revinate, Inc.</p>
        </div>
    </div>
</div>